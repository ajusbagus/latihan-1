...
if(isset($_POST['username'])){
    ...
    if(mysqli_num_rows($cek) > 0 ){ 
        ...
        $_SESSION['user'] = $data;
        // echo "Nama user: " . $_SESSION['user']['nama'];

        echo "<script>alert('Selamat datang, " . $_SESSION['user']['nama'] . "'); location.href= 'index.php'; </script>";
    } else {
        echo '<script>alert("Maaf username/pasword salah")</script>';
    }
}                       
